...
class ClientProfileController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $client->save();
        // dd('working');
        return redirect()->route('home')->with('success', 'Client data successfully added');
    }
    ...
    {
        $clients = ClientProfile::findOrFail($id);
        return view('front.client.edit', compact('clients'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        $client->update();
        // dd('working');
        return redirect()->route('client.index')->with('success', 'Client data successfully updated');
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect()->route('client.index')->with('success', 'Client data successfully deleted');
    }
}
